        ...
        <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="col-span-2">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" class="mt-1 block w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="Enter product title" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="format" id="format" value="<?php echo e(old('format')); ?>" placeholder="e.g., Paperback, Hardback" class="mt-1 block w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" id="price" step="0.01" min="0" value="<?php echo e(old('price')); ?>" class="mt-1 block w-full pl-8 pr-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="0.00" required>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="rating" id="rating" step="0.1" min="0" max="5" value="<?php echo e(old('rating', 4.5)); ?>" class="mt-1 block w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="4.5">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="popularity" id="popularity" min="0" max="100" value="<?php echo e(old('popularity', 75)); ?>" class="mt-1 block w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="75">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="badge" id="badge" value="<?php echo e(old('badge')); ?>" placeholder="e.g., New, Bestseller" class="mt-1 block w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4" class="mt-1 block w-full px-4 py-3 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="Enter product description" required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-gray-50 p-5 rounded-lg border border-gray-200 space-y-3">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="stock" id="stock" value="1" <?php echo e(old('stock', true) ? 'checked' : ''); ?> class="w-5 h-5 rounded border-2 border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Code\chapakhana\resources\views\admin\products\create.blade.php ENDPATH**/ ?>