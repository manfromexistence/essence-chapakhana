                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="has_design_request" id="hasDesignRequest" value="1" <?php echo e(old('has_design_request') ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <span class="ml-2 text-sm font-medium text-gray-700">I need design assistance</span>
                            </label>
                        </div>

                        <div id="designRequestFields" class="space-y-4" style="display: <?php echo e(old('has_design_request') ? 'block' : 'none'); ?>;">
                            <div>
                                <label for="design_request_notes" class="block text-sm font-medium text-gray-700 mb-2">
                                    Design Requirements
                                </label>
                                <textarea id="design_request_notes" name="design_request_notes" rows="4" placeholder="Please describe your design requirements, preferences, colors, style, etc." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('design_request_notes')); ?></textarea>
                                <?php $__errorArgs = ['design_request_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
