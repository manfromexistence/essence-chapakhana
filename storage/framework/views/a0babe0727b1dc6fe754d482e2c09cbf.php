<?php $__env->startSection('title', ($productTitle ?? 'Banner') . ' | Chapakhana'); ?>
    ...
    <div class="bg-white py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="text-xs text-gray-500 flex items-center gap-1">
                ...
                <span>/</span>
                <span class="text-gray-800"><?php echo e($productTitle ?? 'Vinyl Banners'); ?></span>
            </nav>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-8">
                    <h1 class="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                        <?php echo e($productTitle ?? 'Vinyl Banners'); ?>
                ...
                <div class="relative">
                    <div class="rounded-2xl overflow-hidden shadow-2xl">
                        <img src="<?php echo e($productImage ?? 'https://images.unsplash.com/photo-1540317580384-e5d43616528e?w=800&h=600&fit=crop'); ?>" 
                             alt="<?php echo e($productTitle ?? 'Banners'); ?>" 
    ...
    <section class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="addToCartForm" action="<?php echo e(route('cart.add')); ?>" method="POST">
                ...
                <input type="hidden" name="title" value="<?php echo e($productTitle ?? 'Banner'); ?>">
                <input type="hidden" name="category" value="<?php echo e($category ?? 'banners'); ?>">
                <input type="hidden" name="product_type" value="<?php echo e($productType ?? 'banner'); ?>">
                    ...
                    <div class="bg-white border-2 border-gray-200 rounded-lg p-6 sticky top-6">
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            <div class="flex justify-between items-center pb-3 border-b border-gray-200">
                                ...
                                <span class="text-sm font-semibold text-gray-900"><?php echo e(date('M d, Y', strtotime('+5 days'))); ?></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Code\chapakhana\resources\views/products/configure/banner.blade.php ENDPATH**/ ?>