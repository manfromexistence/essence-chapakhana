            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                        <img src="{{ $productImage ?? 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=800' }}" alt="{{ $productTitle ?? 'Business Card' }} Preview" class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="addToCartForm" action="{{ route('cart.add') }}" method="POST">
                ...
                <input type="hidden" name="title" value="{{ $productTitle ?? 'Business Card' }}">
                <input type="hidden" name="category" value="{{ $category ?? 'business-cards' }}">
                <input type="hidden" name="product_type" value="{{ $productType ?? 'business-card' }}">
