            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative">
                    <div class="rounded-2xl overflow-hidden shadow-2xl">
                        <img src="{{ $productImage ?? 'https://placehold.co/800x600?text=' . urlencode($productTitle ?? 'Marketing Materials') }}"
                            alt="{{ $productTitle ?? 'Marketing Materials' }}" class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white border-2 border-gray-200 rounded-lg p-6 sticky top-6">
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            <div class="flex justify-between items-center pb-3 border-b border-gray-200">
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-900">{{ date('M d, Y', strtotime('+3 days')) }}</span>
                            </div>
                        </div>
