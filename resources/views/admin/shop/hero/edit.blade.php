...
<div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 max-w-4xl">
        <form action="{{ route('admin.shop-hero.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-3">
                    @if($hero->cover_image)
                        <div class="relative w-full h-56 rounded-xl overflow-hidden border-2 border-gray-200">
                            <img src="{{ $hero->cover_image }}" alt="Current Cover" class="w-full h-full object-cover">
