...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
        <form action="{{ route('admin.service-products.update', $serviceProduct) }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="serviceProductForm">
            @csrf
            @method('PUT')
            ...
            <div class="border-t-4 border-blue-100 pt-6 mt-8">
                ...
                <div id="configOptionsContainer" class="space-y-4">
                    @if($serviceProduct->configOptions->count() > 0)
...
const existingOptions = @json($serviceProduct->configOptions);
